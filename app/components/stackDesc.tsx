...
export const STACK_DESC: StackDescInterface = {
  React: {
    ...
    points: [
      [
        ...
        "React를 사용하여 프로젝트를 개발할 때 다양한 라이브러리를 활용하여 개발 생산성을 높일 수 있습니다. React Router를 사용하여 페이지 라우팅 구현과 Axios를 사용하여 HTTP 요청 처리, Styled Components를 활용한 CSS-in-JS 스타일링 등을 자유롭게 사용합니다.",
      ],
      [
        "Custom Hook 활용",
        "함수형 컴포넌트 문법에 익숙하고, 재사용을 위해 컴포넌트 로직을 함수로 뽑아내어 재사용합니다. 또한, 컴포넌트 기반 아키텍처에 대한 이해를하고 중복되어 있어 가독성이 낮고 유지보수가 어려운 코드를 재사용 가능한 작은 조각으로 나누고, 각 조각을 독립적으로 활용하는데 능숙합니다.",
      ],
      [
        "React 성능 최적화",
        "React를 사용하여 프로젝트를 진행할 때, 가상 DOM을 통한 성능 최적화에 대해 고려를 합니다. Redux를 활용하여 전역 상태관리를 할 수 있고, React.memo 등 여러 성능 최적화 라이브러리에 대해 공부합니다.",
      ],
    ],
  },
  Next: {
    ...
    points: [
      [
        "서버 사이드 렌더링(SSR)",
        "Next.js를 사용하여 서버 사이드 렌더링(SSR)과 정적 사이트 생성(SSG)을 구현한 경험이 있습니다. 이로써 초기 로딩 시간을 최적화하고 SEO의 향상에 대한 이해를 높였습니다.",
      ],
      [
        "라우팅 및 코드 스플리팅",
      ...
      [
        ...
        "Next.js를 사용하여 프로젝트를 개발하면서 Tailwind CSS를 처음 접하게 되었고, Tailwind의 강력한 커스터마이징 기능을 적극 활용하여 CSS 작성 시간을 절약할 수 있었습니다.",
      ],
    ],
  },
  Node: {
    ...
    points: [
      [
        "서버 개발",
        "Node.js를 사용하여 서버 사이드 개발을 수행한 경험이 있습니다. Express와 함께 사용하여 RESTful API를 설계하고 구현했습니다. 또한, ejs를 활용한 프론트를 구현하는데 있어서도 능숙합니다.",
      ],
  ...
  JavaScript: {
    ...
    points: [
      [
        "웹 개발",
        "JavaScript를 사용하여 동적이고 상호작용적인 웹 애플리케이션을 개발한 경험이 있습니다. React와 Next.js 등을 사용하여 프론트엔드 개발을 수행했습니다.",
      ],
  ...
  CSS: {
    ...
    points: [
      ...
      [
        "스타일링",
        "CSS 기본 문법에 대한 높은 이해도를 가지고 있으며, 디지털 정부서비스 UI/UX 가이드라인 등의 디자인 표준을 참고하여 웹 페이지를 구현할 수 있습니다.",
      ],
  ...
  ts: {
    ...
    points: [
      ...
      [
        "타입스크립트 이해",
        "TypeScript를 사용하여 타입을 추가하고 런타임 오류를 사전에 방지할 수 있으며, 코드의 가독성과 유지보수성 향상에 대한 이해도를 가지고 있습니다.",
      ],
    ],
  },
  Flutter: {
    ...
    points: [
      [
        "크로스 플랫폼 개발",
        "Flutter를 사용하여 안드로이드 및 iOS 플랫폼을 대상으로 한 모바일 애플리케이션을 개발한 경험이 있습니다. 하나의 코드베이스로 여러 플랫폼을 대응하여 개발 생산성을 높였습니다.",
      ],
  ...
  MySQL: {
    ...
    points: [
      [
        "데이터베이스 설계 및 모델링",
        "MySQL을 사용하여 다양한 프로젝트에 대한 데이터베이스를 설계하고 모델링한 경험이 있습니다. 기본적인 정규화의 개념을 이해하고 효율적인 데이터 구조를 구축하여 데이터 관리 및 검색 성능을 최적화했습니다.",
      ],
  ...
  Python: {
    ...
    points: [
      ...
      [
        "NLP & BERT",
        "자연어 처리를 위해 KoNLPy와, 텍스트 기반 데이터에서 감정을 추출하기 위해 KoBERT를 사용하여 프로젝트를 개발한 경험이 있습니다. 해당 프로젝트에서 KoBERT를 활용하여 텍스트 데이터를 학습시켰으며, 해당 모델과 GPT를 사용하여 감정 분석 기반 AI 챗봇 시스템을 개발한 경험이 있습니다.",
      ],
      [
        "웹 스크래핑",
        "Beautiful Soup와 같은 라이브러리를 사용하여 웹 스크래핑 및 데이터 수집 프로젝트를 진행한 경험이 있습니다. 웹페이지에서 데이터를 추출하고 구조화하여 분석 및 활용할 수 있도록 처리했습니다.",
      ],
    ],
  },
  Android: {
    ...
    points: [
      ...
      [
        "데이터베이스 연동",
        "안드로이드의 보안상의 이유로 인해 외부 데이터베이스(MySQL)에 직접적으로 접근하지 못해서 Retrofit2를 활용한 경험이 있습니다. 안드로이드와 Node.js를 연결하여 데이터베이스(MySQL)와 간접적으로 데이터를 주고받는 방식을 사용했습니다.",
      ],
    ],
  },
  Arduino: {
  ...
  AWS: {
    title: "AWS",
    level: 2,
    points: [["EC2 인스턴스 관리", "Amazon EC2를 사용하여 웹 애플리케이션의 서버를 관리하고, EC2 인스턴스 구성, 탄력적 IP 등의 경험이 있습니다."]],
  },
  Github: {
    title: "Github",
    level: 3,
