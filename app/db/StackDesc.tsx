...
export const STACK_DESC: StackDescInterface = {
  react: {
    ...
    points: {
      "React 생태계의 다양한 라이브러리 활용": [
        "React를 사용하여 프로젝트를 개발할 때 다양한 라이브러리를 활용하여 개발 생산성을 높입니다.",
        "React Router를 사용하여 페이지 라우팅을 구현하고, Axios를 사용하여 HTTP 요청을 처리하며, Styled Components를 활용한 CSS-in-JS 스타일링 등을 자유롭게 사용합니다.",
      ],
      "Custom Hook 활용": [
        "함수형 컴포넌트 문법에 익숙하며, 재사용을 위해 컴포넌트 로직을 함수로 뽑아냅니다.",
        "컴포넌트 기반 아키텍처에 대한 이해를 바탕으로, 가독성이 낮고 유지보수가 어려운 코드를 재사용 가능한 작은 조각으로 나누어 각 조각을 독립적으로 활용하는 데 능숙합니다.",
      ],
      "React 성능 최적화": [
        "React를 사용하여 프로젝트를 진행할 때, 가상 DOM을 통한 성능 최적화를 고려합니다.",
        "Redux를 활용하여 전역 상태 관리를 하고, React.memo 등 다양한 성능 최적화 기법을 공부하고 적용하고자 합니다.",
      ],
    },
  },
  next: {
  ...
  tw: {
    ...
    level: 3,
    points: {
      "TailWind CSS에 대한 이해": ["Tailwind CSS의 기본 문법을 숙지하고 있으며, 다양한 디자인 및 레이아웃 등을 구현할 수 있습니다."],
      "커스텀 스타일": [
        "Tailwind CSS가 제공하는 한정적인 문법 외에도 필요한 디자인이나 레이아웃 등에 따라 유연하게 여러 스타일을 커스텀하여 사용할 수 있습니다.",
      ],
      "반응형 디자인": ["사용자 디바이스(데스크톱, 태블릿, 모바일)에 따라 적절하게 디자인 요소를 배치할 수 있습니다."],
    },
  },
  css: {
  ...
  mysql: {
    ...
    points: {
      "데이터베이스 설계 및 모델링": [
        "MySQL을 사용하여 프로젝트에 필요한 데이터베이스를 구축하고 설계 및 모델링한 경험이 있습니다.",
        "기본적인 정규화의 개념을 이해하고 효율적인 데이터 구조를 구축하여 데이터 관리 및 검색 성능을 최적화했습니다.",
      ],
      "CRUD 쿼리 작성 및 최적화": [
        "데이터베이스 조작을 위한 Create, Read, Update, Delete에 대한 기본적인 문법을 숙지하고 있으며, 복잡한 쿼리도 구현 가능합니다.",
        "피할 수 없는 상황에서의 다중 JOIN으로 인한 복잡한 쿼리를 작성하고 실행하여 데이터 전달을 수행한 경험이 있습니다.",
      ],
    },
  },
  firebase: {
    ...
    points: {
      "데이터베이스 설계 및 모델링": [
        "Firebase를 사용하여 프로젝트에 필요한 데이터베이스를 구축하고 설계 및 모델링한 경험이 있습니다.",
        "Firebase가 가지고있는 NoSQL의 개념을 이해하고 있으며, 상황에 따라 적절한 데이터베이스 구조를 만들어봤습니다.",
        "Firebase의 Collection, Document의 개념을 이해하고 있습니다.",
      ],
      "CRUD 쿼리 작성": ["데이터베이스 조작을 위한 Create, Read, Update, Delete에 대한 기본적인 문법을 숙지하고 있으며, 복잡한 쿼리도 구현 가능합니다."],
    },
  },
  python: {
    title: "Python",
  ...
  figma: {
    ...
    points: {
      "UI/UX 디자인": [
        "Figma를 사용하여 사용자 인터페이스와 사용자 경험을 설계한 경험이 있습니다.",
        "다양한 프로젝트에서 와이어프레임, 프로토타입, 및 고해상도 디자인을 제작했습니다.",
      ],
      협업: ["Figma를 사용하여 디자인 팀과 협업할 수 있습니다."],
      "디자인 시스템 구축": [
        "일관된 디자인을 유지하기 위해 디자인 시스템을 구축하고 관리한 경험이 있습니다.",
        "컴포넌트와 스타일 가이드를 사용하여 일관성 있는 디자인을 구현했습니다.",
      ],
    },
  },
  android: {
