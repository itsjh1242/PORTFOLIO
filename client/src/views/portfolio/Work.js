      ...
      <S.WorkMain>
        <div className="item1" id="main_item">
          ...
          <div className="pop-up">
            ...
            <p>
              ...
              일기 생성을 하는 시스템을 개발하였습니다. 수기로 일기를 작성하는 것과 비교하여 챗봇과 대화를 하면 자동으로 일기가 생성되고, 해당 일기에 따른 나의
              감정 분포도를 확인할 수 있습니다.
            </p>
        ...
        <div className="item2" id="main_item">
          ...
          <div className="pop-up">
            ...
            <p>
              전통적인 암호 인증 방법의 취약점 증가 · 사이버 공격의 지속적인 진화 및 새로운 위협의 등장으로 보안 강화의 필요성이 증가함에따라, 새로운 암호 인증
              방안을 제안합니다. 모션 인식 기반의 이중 암호 인증은 사용자의 동작 패턴과 숫자 패스워드를 결합하여 보다 강력한 보안성을 제공합니다.
            </p>
            <div className="footer">
